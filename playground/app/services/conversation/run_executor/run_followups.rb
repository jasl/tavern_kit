...
#
class Conversation::RunExecutor::RunFollowups
  ...
  def kick_if_needed!
    ...
    if @speaker&.ai_character?
      copilot_user = Conversation::RunExecutor::CopilotUserFinder.find_active(@space)
      if copilot_user
        Conversation::RunPlanner.plan_copilot_continue!(
          conversation: @conversation,
