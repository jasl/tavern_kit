...
#
# This keeps Conversation::RunPlanner focused on concurrency-safe queue upsert/exclusive
# primitives, while moving policy decisions (guards + speaker selection + timing) into
# a small, testable object.
#
class Conversation::RunPlanner::AutoModePlanner
  ...
  def call
    ...
    queued = Conversation::RunPlanner.send(
