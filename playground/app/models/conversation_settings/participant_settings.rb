  ...
  class ParticipantSettings
    ...
    class ProvidersSettings
      ...
      define_nested_schemas(
        openai: "ConversationSettings::Providers::OpenAIProvider",
        anthropic: "ConversationSettings::Providers::AnthropicProvider",
        gemini: "ConversationSettings::Providers::GeminiProvider",
        xai: "ConversationSettings::Providers::XaiProvider",
        deepseek: "ConversationSettings::Providers::DeepseekProvider",
        qwen: "ConversationSettings::Providers::QwenProvider",
        openai_compatible: "ConversationSettings::Providers::OpenAICompatibleProvider",
      )
...
ConversationSettings::Registry.register(:participant_settings, ConversationSettings::ParticipantSettings)
