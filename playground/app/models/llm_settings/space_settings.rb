...
module LLMSettings
  ...
  class SpaceSettings
    ...
    define_nested_schemas(
      ...
      world_info: "LLMSettings::Resources::WorldInfoSettings",
      memory: "LLMSettings::Resources::MemorySettings",
      rag: "LLMSettings::Resources::RagSettings",
    )
...
LLMSettings::Registry.register(:space_settings, LLMSettings::SpaceSettings)
