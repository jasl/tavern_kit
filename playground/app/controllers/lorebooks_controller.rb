...
class LorebooksController < ApplicationController
  ...
  def update
    if @lorebook.update(lorebook_params)
      respond_to do |format|
        format.html { redirect_to edit_lorebook_path(@lorebook), notice: t("lorebooks.updated") }
  ...
  def duplicate
    ...
    if new_lorebook.save
      redirect_to edit_lorebook_path(new_lorebook), notice: t("lorebooks.duplicated")
    else
  ...
  def import
    ...
    begin
      ...
      if lorebook.save
        redirect_to edit_lorebook_path(lorebook), notice: t("lorebooks.imported", count: lorebook.entries.count)
      else
