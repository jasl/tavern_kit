...
module TavernKit
  ...
  module CharacterCard
    ...
    class << self
      ...
      #
      # @example Write with both V2 and V3 (recommended for compatibility)
      #   TavernKit::CharacterCard.write_to_png(
      #     character,
      #     input_png: "avatar.png",
      #     output_png: "character_card.png"
      #   )
      #
      # @example Write V2 only (legacy compatibility)
      #   TavernKit::CharacterCard.write_to_png(
      #     character,
      #     input_png: "avatar.png",
      #     output_png: "character_card.png",
      ...
      def parse_v2(hash)
        ...
        name = data_hash["name"].to_s
          ...
          # Per spec: tags/creator/character_version/extensions are in data.
          tags = data_hash["tags"]
      ...
      def upgrade_lorebook_for_v3(lorebook)
        ...
        entries.each do |entry|
          ...
          entry["use_regex"] = coerce_boolean(entry["use_regex"])
